          ...
          <div className="flex flex-wrap gap-8 md:flex-nowrap md:items-center md:justify-between md:gap-0">
            ...
            >
              <h2 className="mb-4 w-11/12 text-3xl font-bold text-black dark:text-white xl:text-sectiontitle4">
                Partner With Us to Empower Future Talent
              </h2>
              <p>
                Join our initiative to provide students with industry-relevant skills beyond academics. 
                Enhance your institution's reputation while preparing students for competitive careers.
              </p>
            </motion.div>
            <motion.div
              variants={{
