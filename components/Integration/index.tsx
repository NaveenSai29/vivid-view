        ...
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <SectionHeader
            headerInfo={{
              ...
              subtitle: `Empowering Students for a Competitive Future`,
              description: `Our initiative provides arts, science, and engineering students with exclusive learning modules beyond their regular curriculum, enhancing employability with AI, coding, and government exam preparation skills.`,
            }}
          />
